...
describe('POST /event', function () {
  ...
  const data = { title: 'test event', description: 'even cooler test', location:'location got' };
    //specify the url to be intercepted
    nock("http://localhost:8082")
      //define the method to be intercepted
      .post('/event')
      ...
      .reply(200, {
        "status": 200,
        "events": [
          { title: 'an event', id: 1, description: 'Working on it' },
          { title: 'another event', id: 2, description: 'Working on it' },
          data
        ]
      });
